...
const PaymentMethods = () => {
  ...
  const TransactionsData = [
    {
      img: "/images/svgs/icon-netflix.svg",
    ...
    {
      img: "/images/svgs/icon-upwork.svg",
      title: "Upwork",
  ...
  return (
    <>
      <CardBox className="pb-2">
        ...
        <div className="grid grid-cols-12 mt-2 gap-7">
          ...
          <div className="md:col-span-6 col-span-12">
            ...
            >
              <div className="flex justify-between pb-10">
                ...
                <Image
                  src="/images/svgs/icon-master-card-1.svg"
                  alt="icon"
                  width={33}
                  height={28}
                />
          ...
          <Table className="mt-2">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-base font-semibold pb-2 text-end text-primary dark:text-primary pe-0">
