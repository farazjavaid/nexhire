      ...
      <CardBox>
        ...
        <div className="flex flex-col gap-3 mt-4">
          <div className="flex justify-between">
            <div>
              <p className="text-ld opacity-90 mb-1">Added to Cart</p>
          ...
          <div className="flex justify-between ">
            <div>
              <p className="text-ld opacity-90 mb-1">Reached to Checkout</p>
              <span className="text-[13px] text-darklink">12 clicks</span>
            </div>
            <div>
              <h6 className="text-base font-normal  mb-1">$16,100.00</h6>
              <p className="font-medium text-[13px] text-right text-error">
                -7.4%
              </p>
            </div>
          </div>
