          ...
          <CardBox className="bg-dark dark:bg-lightprimary relative lg:py-12 py-0 md:px-11">
            <div className="lg:w-2/4 w-full lg:pt-0 pt-12">
              ...
              <div className="sm:flex items-center justify-center lg:justify-start gap-3 mb-4 ">
                <Button className="block md:mb-0 mb-3">
                  <Link
                    target="_blank"
                ...
                <Button
                  color={"outlinewhite"}
                  className="block md:mb-0 mb-3 hover:text-dark bg-transparent text-white hover:bg-white dark:hover:bg-white rounded-lg  border border-white rounded-full"
                >
                  <Link target="_blank" href="https://support.wrappixel.com/">
                    Submit Ticket
                  </Link>
                </Button>
              </div>
