        ...
        <div className="container relative">
          <div className="grid grid-cols-12 gap-6">
            <div className="lg:col-span-3 col-span-12 lg:inline hidden text-end">
              <Image
                src={"/images/landingpage/background/banner-bg-1.png"}
              ...
              />
              <Image
                src={"/images/landingpage/background/banner-widget-1.svg"}
                className="animted-img "
                alt="banner"
                width={166}
                height={186}
              />
            ...
            <div className="lg:col-span-6 col-span-12 flex flex-col">
              <div className="text-center">
                <h1
                  className="md:text-[64px] text-4xl font-bold sm:leading-[74px] sm:mt-12"
                  data-aos="fade-up"
                  data-aos-delay="400"
                ...
                <div
                  className="flex gap-3.5 justify-center my-[30px]"
                  data-aos="fade-up"
                  data-aos-delay="600"
                  data-aos-duration="1000"
                >
              ...
              <div className="mt-auto lg:block hidden">
                <Image
                  src={"/images/landingpage/background/banner-bg-3.png"}
                  alt="banner"
                  width={788}
                  height={212}
                />
            ...
            <div className="lg:col-span-3 col-span-12 lg:inline hidden">
              <Image
                src={"/images/landingpage/background/banner-bg-2.png"}
              ...
              />
              <Image
                src={"/images/landingpage/background/banner-widget-2.svg"}
