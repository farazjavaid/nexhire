  ...
  return (
    <>
      <Accordion type="single" collapsible className="w-full mt-4  ">
        <AccordionItem value="demos" className="border-b-0">
                      ...
                      {item.link != "" ? (
                        <>
                          <Button
                            asChild
                            size={"sm"}
                            className="text-xs absolute rounded-full  left-0 right-0 flex justify-center items-center w-fit mx-auto invisible group-hover:visible z-[1]"
                          >
        ...
        <AccordionItem value="frontendpages" className="border-b-0">
                      ...
                      {item.link != "" ? (
                        <>
                          <Button
                            ...
                            className="text-xs absolute  left-0 right-0 flex justify-center items-center w-fit mx-auto invisible group-hover:visible z-[1]"
                          >
                            <Link href={item.link}>Live Preview</Link>s
                          </Button>
                          <div className="absolute top-0 bottom-0 left-0 h-full w-full bg-blue-100  mix-blend-multiply invisible group-hover:visible"></div>
                        </>
                      ) : null}
