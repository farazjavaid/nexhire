    ...
    <div className="editor-container">
      ...
      <div className="toolbar flex gap-5">
        <button onClick={handleBold}>
          <Icon
            className="text-lg font-semibold text-dark dark:text-bodytext hover:text-primary dark:hover:text-primary"
            icon="tabler:bold"
          />
        </button>
        ...
        <button onClick={handleH1}>
          <span className="text-sm font-medium text-dark dark:text-bodytext hover:text-primary dark:hover:text-primary">
            H1
          </span>
        </button>
