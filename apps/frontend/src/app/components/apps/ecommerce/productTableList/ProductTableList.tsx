  ...
  return (
    <>
                ...
                <AnimatedTableBody className="divide-y divide-border dark:divide-darkborder ">
                  {filteredAndSortedProducts.length === 0 ? (
                    <TableRow>
                      <TableCell
                        colSpan={6}
                        className="text-center py-10 text-ld"
                      >
                          ...
                          <TableCell className="whitespace-nowrap">
                            <DropdownMenu modal={false}>
                              <DropdownMenuTrigger asChild>
                                <span className="h-9 w-9 flex justify-center items-center text-darklink dark:text-bodytext rounded-full hover:bg-lightprimary hover:text-primary cursor-pointer">
            ...
            <div className="grid grid-cols-12 gap-6 pt-4">
              ...
              <div className="col-span-12 lg:col-span-6">
                ...
                <DatePicker
                  ...
                  className="form-control-input w-full max-w-full py-2.5 border border-input rounded-md px-3"
                  id="dt"
                />
              </div>
      ...
      {showAlert && (
        <Alert
          variant="warning"
          className="fixed mx-auto start-0 end-0 top-15 w-fit"
        >
