        ...
        <ul className="my-4">
          {filterData.map((item) => {
            ...
            return (
              <li
                key={item.id}
                className={`py-2.5 gap-2 px-4 rounded-md cursor-pointer capitalize flex hover:bg-lighthover hover:text-primary mb-0.5 dark:hover:bg-darkmuted ${filter === item.name ? "text-primary bg-lighthover dark:bg-darkmuted" : "bg-hover  rounded-md text-ld"}`}
