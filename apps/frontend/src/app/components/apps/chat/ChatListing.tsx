      ...
      <div className="left-part w-full px-0">
        ...
        <div className="flex justify-between items-center px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-darklink dark:text-bodytext text-xs">
                Designer
              </p>
            </div>
          </div>
        ...
        <SimpleBar className="md:h-[calc(100vh_-_520px)] h-[calc(100vh_-_200px)]">
          {filteredChats.map((chat) => (
            <div
              key={chat.id}
              className={`cursor-pointer py-4 px-6 gap-0 flex justify-between group hover:bg-lighthover dark:hover:bg-darkmuted bg-hover  mb-0.5 ${
