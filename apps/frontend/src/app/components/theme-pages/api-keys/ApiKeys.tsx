              ...
              <TableBody className="divide-y divide-border dark:divide-darkborder ">
                {keysData.map((key) => (
                  <TableRow key={key.id}>
                        ...
                        <div className="flex rounded-lg">
                          ...
                          >
                            <button
                              ...
                              className=" cursor-pointer flex items-center gap-2 px-4 py-2.5 text-sm text-ld dark:text-lightgray  transition w-full h-full"
                            >
                              {copied === key.id ? (
                                <>
                                  <Icon
                    ...
                    <TableCell className="text-ld dark:text-lightgray whitespace-nowrap">
                      {key.created}
                    </TableCell>
                    <TableCell className=" text-ld dark:text-lightgray whitespace-nowrap">
                      {key.lastUsed}
