    ...
    <>
      ...
      <div className="flex items-center justify-center">
        <div className="flex gap-2">
          <p className="text-ld font-semibold">Monthly</p>
          <Switch
            checked={switch1}
            onCheckedChange={() => setSwitch1(!switch1)}
            // className="after:bg-white"
          />
          <p className="text-ld font-semibold"> Yearly</p>
        </div>
      </div>
                ...
                <ul className="border-0 mt-5 dark:bg-transparent">
                  {price.rules.map((rule, i) => (
                    <React.Fragment key={i}>
                      {rule.limit ? (
                        <>
                          <li className="flex items-center gap-2 pb-4 text-ld font-medium">
                            <TbCheck size={15} className="text-primary" />
                            {rule.title}
                          </li>
                        </>
                      ) : (
                        <li className="flex items-center gap-2 pb-4 opacity-70 text-ld font-medium ">
                          <TbX size={15} />
                          {rule.title}
                        </li>
                      )}
