...
export default function OrderDataTable({ data }: OrderTableProps) {
                  ...
                  <>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <button
                          className="btn-circle-hover cursor-pointer p-0 h-7 w-7 bg-white dark:bg-darkgray shadow dark:shadow-white/20"
                          aria-label="menu"
                        >
                          <Icon
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-ld dark:text-white mb-4">
        Orders History
      </h3>
      ...
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between my-5">
        <h3 className="text-lg font-semibold text-ld dark:text-white mb-4 md:mb-0">
          Orders Table
        </h3>
        <div className="flex flex-wrap items-center gap-1 md:gap-2">
          ...
          {!showSearch ? (
            <button
              ...
              className="p-2  text-ld rounded-full hover:bg-lightprimary dark:hover:bg-darkprimary border border-transparent focus:outline-none transition hover:cursor-pointer"
            >
              <Icon
          ...
          <button
            ...
            className={`p-2  text-ld rounded-full border border-transparent  focus:outline-none transition hover:cursor-pointer hover:bg-lightprimary dark:hover:bg-darkprimary`}
          >
            {showFilters ? (
              <Icon
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className=" text-ld btn-circle-hover cursor-pointer p-0 h-9 w-9 hover:text-link dark:hover:text-darklink"
                aria-label="Settings"
                type="button"
              >
                <Icon
          ...
          <button
            ...
            className="flex text-ld items-center gap-1 p-2 rounded-full hover:bg-lightprimary dark:hover:bg-darkprimary border border-transparent focus:border-primary focus:outline-none transition hover:cursor-pointer"
              ...
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={`justify-start text-left w-full border border-ld text-ld hover:bg-transparent hover:border-primary ${
                    !columnFilters.date
                      ? "text-ld-foreground hover:text-ld-foreground"
      ...
      {table.getPageCount() > 0 ? (
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mt-4 gap-3">
          {/* Page Size Selector */}
          <div className="flex items-center gap-2">
            <p className="text-sm text-ld dark:text-lightgray">Show</p>
            <Select
            ...
            <p className="text-sm text-ld dark:text-lightgray">per page</p>
          </div>
          <div className="flex items-center gap-3">
            {/* Page Summary */}
            <div>
              <p className="text-sm font-normal text-ld dark:text-lightgray">
                {table.getRowModel().rows.length > 0
                  ? `${
            ...
            <div className="flex items-center gap-2">
              <Icon
                ...
                className={`text-ld dark:text-white hover:text-primary cursor-pointer ${
