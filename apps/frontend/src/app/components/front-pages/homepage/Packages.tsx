            ...
            {Licenses.map((item, index) => {
              return (
                <div
                  ...
                  key={index}
                >
                  <div className="p-6 rounded-xl border border-ld">
                    <div className="pb-8">
                    ...
                    <div className="mt-8 flex flex-col gap-3.5">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <p className="text-base text-ld font-medium tracking-wide">
                          Full source code
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        {item.isSaasUse ? (
                          ...
                          <>
                            ...
                            />
                            <p className="text-base text-ld font-medium tracking-wide opacity-90">
                              Use in SaaS app
                            </p>
                          </>
                        )}
                      ...
                      <div className="flex items-center gap-2">
                        <p className="text-base text-ld flex items-center gap-1 font-medium tracking-wide">
                          <Icon
                            icon="tabler:circle-check"
                            className="text-xl text-secondary dark:text-dar-secondary "
                          />
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        />
                        <p className="text-base text-ld font-medium tracking-wide whitespace-nowrap">
                    ...
                    <div className="mt-8">
                      <Button
                        size={"lg"}
                        className="text-lg py-0 bg-dark dark:bg-darkgray hover:dark:bg-primary hover:bg-primaryemphasis text-white font-medium rounded-md w-full"
                      >
                        Purchase Now
                      </Button>
                    </div>
