        ...
        <div className="grid grid-cols-12 gap-7">
          <div className="lg:col-span-5 col-span-12">
            ...
            <div className="flex  items-center md:mt-0 mt-4  gap-4 custom-controls">
              ...
              />
              <span className="counter text-base font-medium text-darklink">
                    ...
                    <div className="flex justify-between items-center pt-10">
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          <p className="text-base font-medium text-ld opacity-50">
                            {item.subtitle}
                          </p>
                        </div>
                      </div>
...
const NextArrow = ({ onClick }: { onClick: () => void }) => {
  return (
    <div
      ...
      onClick={onClick}
    >
      <Icon icon="tabler:chevron-right" className="text-darklink text-xl" />
    </div>
  );
};
...
const PrevArrow = ({ onClick }: { onClick: () => void }) => {
  return (
    <div
      ...
      onClick={onClick}
    >
      <Icon icon="tabler:chevron-left" className="text-darklink text-xl " />
    </div>
  );
};
