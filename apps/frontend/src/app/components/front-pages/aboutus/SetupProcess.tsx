          ...
          <div className="grid grid-cols-12 md:gap-7 gap-6">
            {Feature.map((item, index) => (
              <div
                ...
                key={index}
              >
                <div className={`${item.bgcolor} p-8 rounded-xl`}>
                  <div
                    className={`h-12 w-12 flex-shrink-0 flex items-center justify-center rounded-xl bg-white dark:bg-darkgray shadow-elevation4`}
                  >
                    <Icon
                      icon={item.icon}
                  ...
                  <p className="text-base text-darklink  leading-6">
                    {item.subtitle}
                  </p>
                </div>
              </div>
