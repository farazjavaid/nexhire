          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="lg:col-span-6 col-span-12 lg:text-start text-center">
              ...
              <div className="sm:flex lg:justify-start justify-center gap-5 py-6">
                <Button asChild className="px-4 font-bold sm:w-fit w-full">
            ...
            <div className="lg:col-span-6 col-span-12 lg:text-left text-center">
              <p className="text-base text-ld opacity-90 leading-8 xl:ps-20 pt-4">
                ...
                Nextjs admin template packed with numerous features?{" "}
                <b className="opacity-100">MaterialM Nextjs Admin</b> template
                has everything you need. This Nextjs based admin template is
                designed in accordance with industry standards and best
                practices to provide you.
              </p>
            </div>
          </div>
        </div>
