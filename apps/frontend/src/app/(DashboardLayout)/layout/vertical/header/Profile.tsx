...
const Profile = () => {
  ...
  const displayName = profile
    ...
    : "";
  const displayRole = profile?.roles?.[0]?.replace("_", " ") ?? "";
      ...
      <DropdownMenu dir={activeDir === "rtl" ? "rtl" : "ltr"}>
        ...
        <DropdownMenuContent className="w-screen sm:w-[360px] py-6 px-0 rounded-sm ">
          <div className="px-6">
            ...
            <div className="flex items-center gap-6 pb-5 border-b border-border dark:border-darkborder mt-5 mb-3">
              ...
              <div>
                ...
                <span className="card-subtitle capitalize">{displayRole}</span>
              ...
              >
                <Link href={items.url} className="flex items-center w-full">
                  <div className="flex items-center w-full">
                    <div className={`h-11 w-11 flex-shrink-0 rounded-md flex justify-center items-center ${items.bgcolor}`}>
          ...
          <div className="pt-6 px-6">
            <Button color="primary" className="w-full rounded-full" onClick={handleLogout}>
              Logout
            </Button>
          </div>
        </DropdownMenuContent>
