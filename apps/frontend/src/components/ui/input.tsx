...
const inputVariants = cva(
  "flex h-10 w-full border rounded-3xl px-3 py-2 text-sm disabled:cursor-not-allowed disabled:opacity-50 file:border-0 file:rounded-sm file:text-sm file:font-medium file:text-primary file:bg-lightprimary  focus-visible:outline-0",
  {
    variants: {
      variant: {
        default:
          "border-ld bg-transparent text-ld   dark:placeholder:text-white/30 focus-visible:border-primary focus-visible:ring-0",
