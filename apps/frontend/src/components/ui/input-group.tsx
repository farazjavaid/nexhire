...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-ld bg-transparent shadow-xs relative flex w-full items-center rounded-full border outline-none transition-[color,box-shadow] ",
        ...
        // Focus state.
        "has-[[data-slot=input-group-control]:focus-visible]:ring-primary has-[[data-slot=input-group-control]:focus-visible]:ring-1 dark:has-[[data-slot=input-group-control]:focus-visible]:ring-primary",
